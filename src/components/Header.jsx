      ...
      <div className="flex h-5 items-center">
        ...
        <div className="group flex items-center">
          ...
          <button className="w-[40px] md:w-[60px] h-8 md:h-10 flex items-center border border-l-0 border-[#303030] rounded-r-3xl bg-white/[0.1]">
            <IoIosSearch className="text-white text-xl m-3" />
          </button>
      </div>
      <div className="flex items-center">
        <div className="hidden md:flex">
          ...
          <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
            <img src="https://scontent.fzyl1-1.fna.fbcdn.net/v/t1.6435-1/34664325_2065077857076710_7120027630316814336_n.jpg?stp=dst-jpg_p200x200&_nc_cat=109&ccb=1-7&_nc_sid=2b6aad&_nc_ohc=x1AzsF4c5z8AX-aCg5v&_nc_ht=scontent.fzyl1-1.fna&oh=00_AfB8bo9YEZbo1vbuwzJtOmqvUj5-IvFtUzBefRtTIhOprg&oe=65D479D0" alt='DP'/>
          </div>
        </div>
      </div>
